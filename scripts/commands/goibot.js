...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var tl = ["হ্যা বলো আমি শুনছি😌","হুঁ জান বলো আমি শুনছি 🙂","আমারে ডাকছো তুমি😅","মেয়ে হলে I love you 😘 ছেলে হলে আমার থেকে 300 মিটার দূরে থাক 🥵","I'm হাজির KING SAGOR-bot 🙋‍♂️🙋‍♂️"];
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "i love u bot") || (event.body.toLowerCase() == "i love you bot")) {
     return api.sendMessage("আমাকে না আমার বস সাগরকে ভালোবাসো😻🥀", threadID);
   };
  
    if ((event.body.toLowerCase() == "Bot i love you") || (event.body.toLowerCase() == "Bot i love u")) {
     return api.sendMessage("আমাকে না আমার বস সাগরকে ভালোবাসো😻🥀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bot koire") || (event.body.toLowerCase() == "bot koi")) {
     return api.sendMessage("এই তো আমি এখানে KING SAGOR_ BOT🙋‍♂️", threadID);
   };
